      ...
      <div className="navbar #d946ef ">
        <div className="navbar-start ">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
              ...
              <li><a className="text-lg">Services2</a></li>
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">
            ...
            <li><a href='/Course' className="text-lg">Services</a></li>
            <li><a className="text-lg">About Us</a></li>
            <li><a className="text-lg">contacts</a></li>
        ...
        <div className="navbar-end flex space-x-4 ...">
          <label className="input input-bordered flex items-center gap-2 bg-teal-50 border-current">
